...
class uncertainty_net(nn.Module):
    def __init__(self, in_channels: int, out_channels: int = 1, thres=15, combine: str = 'concat'):
        ...
        out_channels = 3
        self.depthnet = ERFNet(in_channels=in_channels, out_channels=out_channels)
